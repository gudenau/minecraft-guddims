...
import net.gudenau.minecraft.dims.impl.client.renderer.celestial.SunObjectRenderer;
import net.gudenau.minecraft.dims.impl.controller.celestial.controller.SunController;
import net.minecraft.network.PacketByteBuf;
import net.minecraft.util.Identifier;

/**
 * Represents a sun in the sky of a dimension.
 *
 * @since 0.0.4
 */
public final class SunObject implements CelestialDimController.CelestialObject{
    /**
    ...
    /**
     * The rotation of the sun in the sky on the axis it does not rotate on.
     */
    ...
    public SunObject(OptionalInt period, OptionalInt offset, OptionalInt inclination, OptionalInt color){
    ...
    public CelestialObjectRenderer createRenderer(){
        return new SunObjectRenderer(period, offset, inclination, color);
    }
